...
{
    /// <inheritdoc />
    public partial class AddTableToAuth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_admin_profiles_users_id",
                        column: x => x.id,
                        principalSchema: "accounts",
            ...
            migrationBuilder.CreateTable(
                name: "partisipant_accounts",
                schema: "accounts",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    favorite_pets = table.Column<List<Guid>>(type: "uuid[]", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_partisipant_accounts", x => x.id);
                    table.ForeignKey(
                        name: "fk_partisipant_accounts_users_id",
                        column: x => x.id,
                        principalSchema: "accounts",
                        principalTable: "users",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_volunteer_accounts_users_id",
                        column: x => x.id,
                        principalSchema: "accounts",
                        principalTable: "users",
                        principalColumn: "id",
