...
namespace PetFamily.Infrastucture.Extensions
{
    public static class EfCoreFluentApiExtensions
    {
            ...
            Func<TValueObject, TDto> selector)
        {
            ...
            return System.Text.Json.JsonSerializer.Serialize(dtos, JsonSerializerOptions.Default);
        }
        ...
        {
            var dtos = System.Text.Json.JsonSerializer.Deserialize<IEnumerable<TDto>>(json, JsonSerializerOptions.Default) ?? [];
